      ...
      <>
        <ul className="list-inline mb-1 text-muted fw-bold">
          {amMod(this.props.community_view.community.id) && (
            <>
              <li className="list-inline-item-action w-100">
                <button
              ...
              {amTopMod(this.props.moderators) && (
                <li className="list-inline-item-action w-100">
                  ...
                  >
                    ...
                    {I18NextService.i18n.t(
                      !community_view.community.deleted ? "delete" : "restore"
                    )}
                  </button>
                </li>
              )}
          ...
          {amAdmin() && (
            <li className="list-inline-item w-100">
              {!this.props.community_view.community.removed ? (
                ...
                <button
                  className="btn btn-success d-block mb-2 w-100"
        ...
        {this.state.showRemoveDialog && (
          <form onSubmit={linkEvent(this, this.handleRemoveCommunity)}>
            ...
            {/* </div> */}
            <div className="input-group mb-3">
              <button type="submit" className="btn btn-danger d-block mb-2 w-100">
                {this.state.removeCommunityLoading ? (
                  <Spinner />
                ) : (
