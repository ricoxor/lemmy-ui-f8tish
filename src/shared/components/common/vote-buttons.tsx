      ...
      <>
        ...
        >
          {this.state.upvoteLoading ? (
            ...
            <>
              <Icon icon="arrow-up1" classes="icon-inline large" />
              {showScores() &&
                this.props.voteContentType === VoteContentType.Post && (
                  <span className="ms-2 large">
        ...
        {this.props.enableDownvotes && (
          ...
          >
            {this.state.downvoteLoading ? (
              ...
              <>
                <Icon icon="arrow-down1" classes="icon-inline large" />
                {showScores() &&
                  this.props.voteContentType === VoteContentType.Post && (
                    <span
                      className={classNames("ms-2 large", {
      ...
      <div className="vote-bar small text-center">
        ...
        >
          {this.state.upvoteLoading ? (
            ...
            <Icon icon="arrow-up1" classes="upvote large" />
          )}
        </button>
        {showScores() ? (
          <div
            className="unselectable pointer text-muted post-score large"
            data-tippy-content={tippy(
              this.props.voteDisplayMode,
              this.props.counts,
            )}
        ...
        {this.props.enableDownvotes && (
          ...
          >
            {this.state.downvoteLoading ? (
              ...
              <Icon icon="arrow-down1" classes="downvote large" />
            )}
          </button>
        )}
      </div>
